...
const raagData = [
    { name: "Raag Bhimpalasi", time: "Afternoon", category: "Mind", bg: "linear-gradient(135deg,#667eea,#764ba2)", desc: "Encourages relaxation, introspection and emotional balance." },
    { name: "Raag Darbari Kanada", time: "Late Night", category: "Mind", bg: "linear-gradient(135deg,#09203f,#537895)", desc: "Healing: Heart disease, child-related issues, honor, positioning in life, and paternal/government relations." },
    { name: "Raag Shuddh Sarang", time: "Afternoon", category: "Health", bg: "linear-gradient(135deg,#56ccf2,#2f80ed)", desc: "Healing: Mental peace, maternal relations, family harmony, trauma, and intangible happiness." },
    { name: "Raag Komal Rishabh Asavari", time: "Morning", category: "Mind", bg: "linear-gradient(135deg,#8360c3,#2ebf91)", desc: "Healing: Mental peace, maternal relations, calmness, family harmony, and emotional trauma." },
    { name: "Raag Yaman", time: "Evening", category: "Harmony", bg: "linear-gradient(135deg,#141e30,#243b55)", desc: "Healing: Mental peace, maternal relations, happiness, family atmosphere, and emotional pain." },
    { name: "Raag Hamsadhwani", time: "Evening", category: "Mind", bg: "linear-gradient(135deg,#ff9a9e,#fecfef)", desc: "Healing: Mental peace, maternal relations, happiness, calmness, family harmony, and trauma." },
    { name: "Raag Bhairavi", time: "Morning / Closing", category: "Mind", bg: "linear-gradient(135deg,#30cfd0,#330867)", desc: "Healing: Insomnia, property-related issues, blood-related problems, violence, and accidents." },
    { name: "Raag Asavari", time: "Late Morning", category: "Health", bg: "linear-gradient(135deg,#e0c3fc,#8ec5fc)", desc: "Healing: Property-related issues, blood-related problems, violence, and accidents." },
    { name: "Raag Desi Todi", time: "Late Morning", category: "Mind", bg: "linear-gradient(135deg,#fbc2eb,#a6c1ee)", desc: "Healing: Property-related issues, blood-related problems, violence, and accidents." },
    { name: "Raag Kalyan", time: "Evening", category: "Harmony", bg: "linear-gradient(135deg,#ff0844,#ffb199)", desc: "Healing: Education troubles, sibling conflicts, thyroid/hormonal imbalances, and communication." },
    { name: "Raag Poorvi", time: "Evening", category: "Career", bg: "linear-gradient(135deg,#f12711,#f5af19)", desc: "Healing: Education troubles, sibling conflicts, hormonal imbalances, and business." },
    { name: "Raag Nat Bhairav", time: "Morning", category: "Career", bg: "linear-gradient(135deg,#f12711,#f5af19)", desc: "Healing: Relationship issues and money-related financial troubles." },
    { name: "Raag Vrindavani Sarang", time: "Afternoon", category: "Harmony", bg: "linear-gradient(135deg,#13547a,#80d0c7)", desc: "Healing: Relationship issues and money-related financial troubles." },
    { name: "Raag Shuddh Kalyan", time: "Evening", category: "Mind", bg: "linear-gradient(135deg,#89f7fe,#66a6ff)", desc: "Encourages peace, clarity and gentle positivity." },
    { name: "Raag Jaunpuri", time: "Late Morning", category: "Health", bg: "linear-gradient(135deg,#4facfe,#00f2fe)", desc: "Healing: Profession-related issues, long-term diseases, and chronic troubles." },
    { name: "Raag Kirwani", time: "Evening", category: "Mind", bg: "linear-gradient(135deg,#43e97b,#38f9d7)", desc: "Healing: Profession-related issues, long-term diseases, and chronic troubles." },
    { name: "Raag Neelambari", time: "Night", category: "Mind", bg: "linear-gradient(135deg,#fa709a,#fee140)", desc: "Healing: Profession-related issues, long-term diseases, and chronic troubles." },
    { name: "Raag Malkauns", time: "Late Night", category: "Mind", bg: "linear-gradient(135deg,#200122,#6f0000)", desc: "Healing: Provides relief from Asthma." },
    { name: "Raag Bhairav", time: "Early Morning", category: "Health", bg: "linear-gradient(135deg,#ff9a9e,#fecfef)", desc: "Healing: Provides relief from Headaches." },
    { name: "Raag Lalit", time: "Early Dawn", category: "Mind", bg: "linear-gradient(135deg,#ffecd2,#fcb69f)", desc: "Healing: Provides relief from Asthma." },
    { name: "Raag Bhoop", time: "Evening", category: "Harmony", bg: "linear-gradient(135deg,#84fab0,#8fd3f4)", desc: "Healing: Regulates and maintains Blood Pressure." },
    { name: "Raag Madhuwanti", time: "Afternoon / Evening", category: "Mind", bg: "linear-gradient(135deg,#37ecba,#72aff3)", desc: "Healing: Helps combat depression and mental stress." },
    { name: "Raag Pilu", time: "Flexible", category: "Harmony", bg: "linear-gradient(135deg,#f6d365,#fda085)", desc: "Healing: Beneficial for those suffering from Anemia." },
    { name: "Raag Shivaranjani", time: "Evening / Night", category: "Mind", bg: "linear-gradient(135deg,#ff0844,#ffb199)", desc: "Healing: Improves retention and helps with memory loss." },
    { name: "Raag Jaijaiwanti", time: "Evening", category: "Mind", bg: "linear-gradient(135deg,#b92b27,#1565c0)", desc: "Healing: Overcomes physical and mental weakness." },
    { name: "Raag Khamaj", time: "Late Evening", category: "Harmony", bg: "linear-gradient(135deg,#a8ff78,#78ffd6)", desc: "Healing: Provides relief from acidity and indigestion." },
    { name: "Tanpura", time: "Continuous Drone", category: "Health", bg: "linear-gradient(135deg,#2b5876,#4e4376)", desc: "Healing: Child-related problems, honor, positioning in life, and relations with father/government." }
];
